...
public class EndorsementServiceImpl implements EndorsementService {
    ...
    @Override
    public EndorsementModel getEndorsementById(UUID id) throws IllegalStateException {
...
//    @Override
//    public EndorsementModel createEndorsement(CreateEndorsementDro createEndorsementDro) {
//        String userId = createEndorsementDro.getEndorseId();
//        Integer skillId = createEndorsementDro.getSkillId();
//
